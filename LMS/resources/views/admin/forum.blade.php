                ...
                <div class="col-md-7 offset-1">
                    <form class="card" style="padding: 20px;"
                        ...
                        <div class="pull-right">
                            <button type="submit" name="Ask" class="btn btn-primary btn-sm" disabled>Ask</button>
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <div class="card">
                            ...
                            <div id="c{{ $question->id }}" class="collapse" role="tabpanel" aria-labelledby="headingOne"
                                ...
                                <textarea type="text" id="answer" name="answer" class="form-control md-textarea"
                                        ...
                                        <div class="pull-right">
                                            <button type="submit" name="Reply" class="btn btn-primary btn-sm" disabled>Reply</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
