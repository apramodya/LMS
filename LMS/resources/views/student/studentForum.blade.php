        ...
        <div class="container-fluid">
            <div class="row" style="padding-bottom: 20px;">
                ...
                <div class="col-md-7 offset-1">
                    <form class="card" style="padding: 20px;"action="{{ route('student-forumQuestion',$forum->course_id) }}" method="post">
                        @csrf
                        <div class="md-form">
                        ...
                        <div class="card">
                            ...
                            <div id="c{{ $question->id }}" class="collapse" role="tabpanel" aria-labelledby="headingOne"
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('student-forumQuestion',$question->id) }}" method="post"
                                          class="container">
                                        @csrf
                                        <div class="md-form">
